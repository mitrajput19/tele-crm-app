class EmployeeHolidaysListRequest {
  int? languageId;
  String? tenantCode;
  ...
  EmployeeHolidaysListRequest.fromJson(Map<String, dynamic> json) {
  ...
  EmployeeHolidaysListRequest copyWith({
    int? languageId,
    String? tenantCode,
    String? tenantCodeEncrypted,
    int? employeeId,
    ...
    return EmployeeHolidaysListRequest(
