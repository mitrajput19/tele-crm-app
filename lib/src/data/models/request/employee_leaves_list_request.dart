class EmployeeLeavesListRequest {
  int? languageId;
  String? tenantCode;
  ...
  EmployeeLeavesListRequest.fromJson(Map<String, dynamic> json) {
  ...
  EmployeeLeavesListRequest copyWith({
    int? languageId,
    String? tenantCode,
    String? tenantCodeEncrypted,
    int? employeeId,
    ...
    return EmployeeLeavesListRequest(
